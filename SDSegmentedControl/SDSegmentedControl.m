...
const NSTimeInterval kSDSegmentedControlDefaultDuration = 0.15;
...
- (void)commonInit
{
    ...
    // Init layer
    self.backgroundColor = [UIColor colorWithRed:(196.0/255.0) green:(190.0/255.0) blue:(186.0/255.0) alpha:1];
    ...
    self._selectedStainView.backgroundColor = [UIColor colorWithRed:(196.0/255.0) green:(190.0/255.0) blue:(186.0/255.0) alpha:1];
}
...
- (void)layoutSegments
{
    ...
    {
        item.alpha = 1;
        item.frame = CGRectIntegral(CGRectMake(currentItemPosition-1, 0, CGRectGetWidth(item.bounds), itemHeight));
...
+ (void)initialize
{
    ...
    [appearance setTitleColor:[UIColor colorWithRed:(81.0/255.0) green:(77.0/255.0) blue:(74.0/255.0) alpha:1] forState:UIControlStateNormal];
    [appearance setTitleShadowColor:UIColor.clearColor forState:UIControlStateNormal];

    [appearance setTitleColor:[UIColor colorWithRed:(81.0/255.0) green:(77.0/255.0) blue:(74.0/255.0) alpha:1] forState:UIControlStateSelected];
...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
    {
        ...
        self.titleEdgeInsets = UIEdgeInsetsMake(0, 0.0, 0, -10.0); // Space between text and image
...
+ (void)initialize
{
    ...
    appearance.shadowOffset = CGSizeMake(0, .4);
