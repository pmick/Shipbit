...
// Used to propegate saves to the persistent store without blocking the UI
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Shipbit" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSDictionary *options = @{ @YES: NSMigratePersistentStoresAutomaticallyOption,
